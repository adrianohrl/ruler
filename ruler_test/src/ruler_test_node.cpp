...
int main(int argc, char** argv)
{
  ...
  ros::Duration d(1.0);
  utilities::functions::ContinuousStepFunction* f1 =
      new utilities::functions::ContinuousStepFunction(0.0, 5 * d.toSec(), 0.0, 10.0);
  utilities::functions::DiscreteStepFunction* f2 =
      new utilities::functions::DiscreteStepFunction(0.5, 2.5 * d.toSec(), 0.0, 4.0);
  t1->addResource(r1);
  t1->addResource(r2);
  t1->addResource(r3);
  t1->addResource(r4);
